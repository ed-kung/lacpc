...
The CPC meets approximately every two weeks. The agenda for each meeting is set by the Commission itself and made available to the public at least 7 days before each meeting. After each meeting, the meeting minutes are published online. The minutes record the order of discussion, the members present, the motions made on each agenda item, and the votes made on each motion. Motions are passed by majority rule, subject to a quorum of five members present. In addition, members of the public are allowed to submit comments on any agenda item either in writing or in person during the meeting. 

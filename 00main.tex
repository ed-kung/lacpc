...
\end{center}
\vspace{-0.4cm}
{\footnotesize \textit{Note}: Shows how much of the total variance in the 1,536 dimensional embedding space of the corpus of \gn{NumberOfCases} agenda items is explained by each principal component.}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{threeparttable}
      \centering
      \input{tables/ologit_main_effects}
...
\begin{table}[H]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{threeparttable}
      \input{tables/ologit_marginal_effects}

...
The resulting dataset contains \gn{NumberOfCases} agenda items. Table \ref{tab_result_unanimity} shows the distribution of the hearing outcomes, by implication for the proposed project and by the unanimity of the vote. Two important facts emerge about the CPC process. First, a minuscule number of projects are denied outright (\gn{NumberCasesDeniedPct} of all projects). Rat
